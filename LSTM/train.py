...
if __name__ == "__main__":
    ...
    if args.sport == 'deadlift':
        ...
        save_dir = os.path.join(os.path.dirname(__file__), 'checkpoints', f'LSTM_Deadlift_{feat_type}', args.tag)
        num_classes = 4
        input_len = 110
    else:
        # Benchpress
        ...
        save_dir = os.path.join(os.path.dirname(__file__), 'checkpoints', f'LSTM_Benchpress', args.tag)
        num_classes = 4
        input_len = 100
    ...
    for i, (t_idx, v_idx, test_indices) in enumerate(dataset_folds):
        ...
        save_path = os.path.join(save_dir, f"LSTM_model_fold{i}.pth")
        txt_dir = os.path.join(save_dir, f"LSTM_model_fold{i}_results")
